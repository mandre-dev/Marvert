...
import { convertDocxToPdf, downloadPdfFile } from '../services/docxToPdf'
  ...
  return (
    <div className="max-w-3xl mx-auto px-4 py-12">
      ...
      <div className="text-center mb-10">
        ...
        <h1 className="text-2xl sm:text-3xl font-bold text-white mb-2">DOCX → PDF</h1>
        <p className="text-gray-500 text-sm">Converta seu documento Word para PDF.</p>
        <p className="text-xs text-yellow-500 mt-2">⚠️ Formatação e imagens podem não ser preservadas.</p>
      </div>
      <div
        onClick={handleClick}
        onDrop={handleDrop}
