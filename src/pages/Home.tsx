...
const categories = [
  ...
  },
  {
    ...
    conversions: [
      ...
      { from: 'PDF', to: 'ODT', route: '/pdf-to-odt', description: 'Converta PDF para LibreOffice', icon: '📝', color: 'text-cyan-300', border: 'hover:border-cyan-300', bg: 'hover:bg-cyan-300/5' },
      { from: 'PDF', to: 'ODS', route: '/pdf-to-ods', description: 'Converta PDF para LibreOffice Calc', icon: '📊', color: 'text-indigo-300', border: 'hover:border-indigo-300', bg: 'hover:bg-indigo-300/5' },
    ...
    <div className="max-w-5xl mx-auto px-4 py-12">
      ...
      <div className="mt-16 pt-8 border-t border-gray-800 flex flex-col sm:flex-row items-center justify-between gap-4">
        <div className="text-xs text-gray-600">
          Marvert © 2026 · Desenvolvido por Marcos André
        </div>
