...
import { convertPdfToOds, downloadOds } from '../services/pdfToOds'

function PdfToOdsPage() {
    ...
    async function handleFile(file: File) {
        setLoading(true)
        try {
            const blob = await convertPdfToOds(file)
            const newName = file.name.replace(/\.pdf$/i, '.ods')
            downloadOds(blob, newName)
    ...
    return (
        <div className="max-w-3xl mx-auto px-4 py-12">
            ...
            <div className="text-center mb-10">
                ...
                <h1 className="text-2xl sm:text-3xl font-bold text-white mb-2">PDF → ODS</h1>
                <p className="text-gray-500 text-sm">O texto será extraído e salvo em formato LibreOffice Calc.</p>
