...
import { convertPdfToDocx, downloadDocx } from '../services/pdfToDocx'

function PdfToDocxPage() {
  ...
  return (
    <div className="max-w-3xl mx-auto px-4 py-12">
      ...
      <div className="text-center mb-10">
        ...
        <h1 className="text-2xl sm:text-3xl font-bold text-white mb-2">PDF → DOCX</h1>
        <p className="text-gray-500 text-sm">O texto será extraído e salvo em formato Word.</p>
