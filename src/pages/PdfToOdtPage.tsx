...
import { convertPdfToOdt, downloadOdt } from '../services/pdfToOdt'

function PdfToOdtPage() {
    ...
    async function handleFile(file: File) {
        setLoading(true)
        try {
            const blob = await convertPdfToOdt(file)
            const newName = file.name.replace(/\.pdf$/i, '.odt')
    ...
    return (
        <div className="max-w-3xl mx-auto px-4 py-12">
            ...
            <div className="text-center mb-10">
                ...
                <h1 className="text-2xl sm:text-3xl font-bold text-white mb-2">PDF → ODT</h1>
                <p className="text-gray-500 text-sm">O texto será extraído e salvo em formato LibreOffice.</p>
